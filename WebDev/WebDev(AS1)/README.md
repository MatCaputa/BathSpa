...
## Repository Info
A folder has been provided for each Set Exercise. Each folder contains the files you will need for that exercise. You should start by reading the `README` file first. 
